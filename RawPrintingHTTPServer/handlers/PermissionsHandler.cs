...
namespace RawPrintingHTTPServer.handlers
{
    class PermissionsHandler
    {
        ...
        public bool handle(HttpListenerRequest req, HttpListenerResponse resp, string accesslog, string origin = null)
        {
        ...
        private bool _handleGet(HttpListenerRequest req, HttpListenerResponse resp, string accesslog, string origin)
        {
